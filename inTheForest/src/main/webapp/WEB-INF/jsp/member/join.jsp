				...
				<div class="board-write">
					...
					<div class="form-group row">
						...
						<div class="form-group row">
							...
							<div class="form-control-body form-inline">
								<input class="form-control" type="text" name="tel" id="phone" placeholder=" 010 - 1234 - 5678">
							</div>
						</div>
						<div class="form-group row">
